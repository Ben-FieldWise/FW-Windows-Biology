...
test("packaged paths normalize on Windows and POSIX runners",()=>{assert.equal(normalizePackagePath("\\\\electron\\\\main.cjs"),"/electron/main.cjs");assert.equal(normalizePackagePath("src/app.mjs"),"/src/app.mjs");});
